...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column('presentations_created', sa.Integer(), nullable=False, server_default='0'),
        sa.Column('exports_used', sa.Integer(), nullable=False, server_default='0'),
        sa.Column('assets_uploaded', sa.Integer(), nullable=False, server_default='0'),
        sa.Column('ai_messages_sent', sa.Integer(), nullable=False, server_default='0'),
